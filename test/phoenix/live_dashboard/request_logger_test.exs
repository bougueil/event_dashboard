defmodule EventDashboard.RequestLoggerTest do
  use ExUnit.Case, async: true

  use Plug.Test
  alias EventDashboard.RequestLogger
  ...
  test "sets logger metadata for matching param" do
    ...
    assert Logger.metadata()[:logger_pubsub_backend] ==
             {EventDashboardTest.PubSub, "phx_dashboard:request_logger:rstream"}
  end
  ...
  test "sets logger metadata for matching cookie" do
    ...
    assert Logger.metadata()[:logger_pubsub_backend] ==
             {EventDashboardTest.PubSub, "phx_dashboard:request_logger:cstream"}
  end
end
